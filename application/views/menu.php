                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">  
                            ...
                            <li><a href=<?= site_url('/make_vehicle_motor_control/consultMake'); ?>>Marca vehi. motor</a></li>
                            ...
                            <li><a href=<?= site_url('/part_vehicle_control/urlVehicleTypeConsult'); ?>>Pieza tip. Vehiculo</a></li> 
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href=<?= site_url('/make_vehicle_motor_control/consultMakeVehicleMotor'); ?>>Marcas vehi. motor</a></li>
                            ...
                            <li><a href=<?= site_url('/vehicleType_control/urlVehicleTypeConsult'); ?>>Tipos Vehiculos</a></li>
