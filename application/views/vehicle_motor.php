<html>
    ...
    <body>
        ...
        <div class="container col-lg-5" style="margin-left: 20%">
            <form id="vehicleMotorForm" method="post">
                <div class="form-group">
                    <label for="vehicleMotor" class="col-lg-12 control-label">Tipo Vehiculo motor</label>
                    <input type="text" class="form-control" name="vehicleMotor" id="idVehicleMotor">   
                </div>
                <div id="idmensaje"></div>
                <div>
                    <button type="submit" class="btn btn-lg btn-primary" id="btnVehicleMotor"><span class="glyphicon glyphicon-ok-sign"></span> Enviar</button>
                </div>
            </form>   
        </div>
