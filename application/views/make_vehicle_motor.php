...
<html lang="en">
    <head>
        ...
        <title>Marca Vehiculo de motor</title>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="editFormMakeVehicleMotor" method="POST">
                            ...
                            <div class="modal-footer ">
                                <button type="button" class="btn btn-primary btn-lg" style="width: 100%;" id="buttonMakeVechicleMotor" onclick="insertMakeVehicleMotor()">
